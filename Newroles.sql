UPDATE stagehirelines.rolespermissions SET `enable` = 'HR-Admin, HR-Executive' WHERE (`id` = '1');
UPDATE stagehirelines.rolespermissions SET `enable` = 'HR-Admin, HR-Executive' WHERE (`id` = '3');
